...
const Pricing = () => {
    ...
    return (
        <div className='py-12 '>
            ...
            <div className='mt-10 flex gap-12 justify-center items-center text-center '>
                <div className='w-70 bg-white border rounded-lg shadow p-6 flex flex-col gap-6 border-amber-100' >
                    <p className='text-orange-500 font-bold'>{pricing.boxhead1}</p>
                    <p className='text-5xl font-bold '>{pricing.boxhead2}</p>
                    <div>
                ...
                <div className='w-70 relative overflow-hidden  rounded-lg shadow p-6 flex flex-col gap-6 bg-orange-50'>
                    ...
                    <p className='text-5xl font-bold '>{pricing2.boxhead2}</p>
                    <div>
